...
export default function NotificationPanel({ isOpen, onClose }: NotificationPanelProps) {
    ...
    return (
        <div className="fixed inset-0 z-50">
            ...
            <div className="fixed right-0 top-0 h-full w-full md:w-96 bg-white shadow-xl overflow-hidden flex flex-col">
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4 text-white flex items-center justify-between">
                    ...
                    <button onClick={onClose} className="p-2 hover:bg-blue-700 rounded-lg transition" aria-label="Close notifications">
                        <X className="h-6 w-6" />
                    </button>
                </div>
